  ...
  return (
    <section className="py-16 md:py-24 bg-white overflow-hidden">
      ...
      <div className="max-w-[300px] md:max-w-[320px] mx-auto relative group px-4">
        ...
        <button 
          onClick={() => scroll('left')}
          className="absolute -left-4 md:-left-12 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center text-espresso hover:text-terracota transition-all duration-300 border border-espresso/5"
          aria-label="Anterior"
        >
        ...
        <button 
          ...
          className="absolute -right-4 md:-right-12 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center text-espresso hover:bg-terracota hover:text-white transition-all duration-300 border border-espresso/5"
          aria-label="Próximo"
        >
